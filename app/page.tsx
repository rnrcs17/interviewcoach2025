        ...
        <main className="container mx-auto">
          <div className="relative md:mt-24 mx-auto w-full max-w-4xl pt-4 text-center">
            ...
            <h1 className="md:text-7xl my-4 font-extrabold text-4xl md:leading-tight">
              Ace Your Interviews with Interview Coach
            </h1>
            <p className="mx-auto my-4 text-sm w-full max-w-xl text-center font-medium leading-relaxed tracking-wide">
              Interview Coach supports you during live interviews by providing
              tailored answers to interview questions based on your resume and
              the job description. Equipped with features such as question
              recording and AI-driven responses, it ensures you feel confident
              and ready to do well.
            </p>
            <div className="flex flex-row justify-center items-center space-x-4 my-8">
              {/* <Button>Get Started</Button> */}
              <Link href="/dashboard" className="animate-fade">
                <Button variant="secondary">
                  Get Started <HiRocketLaunch className="ml-3 text-2xl" />
                </Button>
              </Link>
            </div>
